...
public class ResponseHeader  implements java.io.Serializable {
    ...
    private com.allmerica.security.userprofile.service.ReturnCodeList returnCodeList;
    ...
    public ResponseHeader(
           ...
           com.allmerica.security.userprofile.service.ReturnCodeList returnCodeList,
     ...
     */
    public com.allmerica.security.userprofile.service.ReturnCodeList getReturnCodeList() {
        return returnCodeList;
    }
     ...
     */
    public void setReturnCodeList(com.allmerica.security.userprofile.service.ReturnCodeList returnCodeList) {
        this.returnCodeList = returnCodeList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.userprofile.security.allmerica.com", "ResponseHeader"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://service.userprofile.security.allmerica.com", "ReturnCodeList"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
