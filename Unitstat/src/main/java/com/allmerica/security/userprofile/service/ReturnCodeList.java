...
public class ReturnCodeList  implements java.io.Serializable {
    private com.allmerica.security.userprofile.service.ReturnCd[] returnCd;

    public ReturnCodeList() {
    }

    public ReturnCodeList(
           com.allmerica.security.userprofile.service.ReturnCd[] returnCd) {
     ...
     * @return returnCd
     */
    public com.allmerica.security.userprofile.service.ReturnCd[] getReturnCd() {
        return returnCd;
    }
     ...
     * @param returnCd
     */
    public void setReturnCd(com.allmerica.security.userprofile.service.ReturnCd[] returnCd) {
        this.returnCd = returnCd;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.userprofile.security.allmerica.com", "ReturnCodeList"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("returnCd");
        elemField.setXmlName(new javax.xml.namespace.QName("", "returnCd"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://service.userprofile.security.allmerica.com", "ReturnCd"));
