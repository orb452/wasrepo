...
/**
 * T1407tId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class T1407tId implements java.io.Serializable {
	...
	/** full constructor */
	public T1407tId(String polNbr, String polSym, Short polMod, String co,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof T1407tId))
			return false;
		T1407tId castOther = (T1407tId) other;
