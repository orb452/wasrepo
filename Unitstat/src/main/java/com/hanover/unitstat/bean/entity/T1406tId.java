...
/**
 * T1406tId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class T1406tId implements java.io.Serializable {
	...
	/** full constructor */
	public T1406tId(String class_, String riskSt) {
		this.class_ = class_;
		this.riskSt = riskSt;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof T1406tId))
			return false;
		T1406tId castOther = (T1406tId) other;
